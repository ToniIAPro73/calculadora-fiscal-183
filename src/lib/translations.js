...
export const translations = {
  en: {
    ...
    scenario: {
      ...
      newOverReal: "new over real stays",
    ...
    userDetails: {
      ...
      advisorLogoHelp: "PNG, JPG or WebP, max. 5 MB. Large images are resized automatically. Only used in your PDF header.",
      advisorLogoTooLarge: "The logo exceeds the 5 MB limit.",
      advisorLogoInvalidType: "Invalid format. Use a PNG, JPG or WebP image.",
  ...
  es: {
    ...
    scenario: {
      ...
      newOverReal: "nuevos sobre lo real",
    ...
    userDetails: {
      ...
      advisorLogoHelp: "PNG, JPG o WebP, máx. 5 MB. Las imágenes grandes se redimensionan solas. Solo se usa en la cabecera de tu PDF.",
      advisorLogoTooLarge: "El logo supera el límite de 5 MB.",
      advisorLogoInvalidType: "Formato no válido. Usa una imagen PNG, JPG o WebP.",
